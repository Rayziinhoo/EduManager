    ...
    return (
        <form className="flex flex-col gap-4 bg-white p-8 rounded-2xl shadow-lg border border-blue-900/20 max-w-md">
            ...
            <div className="flex items-center justify-end gap-4 mt-2">
                <Link href="/notas" className="px-4 py-2 border-2 border-purple-900 text-purple-900 font-semibold rounded-lg hover:bg-purple-900 hover:text-white transition-colors"> Cancelar</Link>
